...
namespace NewEndpoint
{
    public class NewEndpoint : ResultsServices
    {
        ...
        private String Process_Title(String title, int artificial_title_length_limitation)
        {
            ...
            {
                //tracer.Add_Trace("NewEndpointServices.Get_Search_Results_Set", "Title was wrapped with square brackets, removed.");
            ...
            if (artificial_title_length_limitation != -1)
            {
                //tracer.Add_Trace("NewEndpointServices.Get_Search_Results_Set", "Title word limit was set [" + artificial_title_length_limitation + "].");
